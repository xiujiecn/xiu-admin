...
var (
	// 角色数据范围: 1全部数据权限 2自定数据权限 3本部门数据权限 4本部门及以下数据权限 5仅本人数据权限 6本部门及以下或本人数据权限 7本组织及本组织下一级数据权限 8本组织下一级数据权限
	SysRoleMenuDataScopeRole               = "0"
	...
	SysRoleDataScopeOrgNextLevel           = "8"
)
